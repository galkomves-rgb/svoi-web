  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-amber-50/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-4 px-4 py-4 lg:px-6">
        <Link href="/" className="inline-flex items-center gap-3" aria-label="SVOI головна">
          <span className="inline-flex h-11 items-center justify-center rounded-xl bg-blue-900 px-4 text-sm font-extrabold tracking-[0.2em] text-white">
            SVOI
          </span>
