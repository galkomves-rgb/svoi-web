    ...
    <aside className="hidden lg:block">
      <div className="sticky top-28 space-y-4 rounded-[1.75rem] border border-white/70 bg-white/86 p-4 shadow-[0_16px_36px_rgba(15,23,42,0.08)]">
        <div className="space-y-2 rounded-[1.25rem] bg-gradient-to-br from-slate-950 via-blue-950 to-blue-900 px-4 py-4 text-white">
          <p className="eyebrow-light">Локальний контекст</p>
        ...
        <div className="space-y-2">
          <p className="px-1 eyebrow-muted">Розділи</p>
          <nav aria-label={`Навігація по ${city.name}`} className="grid gap-1.5">
        ...
        <div className="surface-muted px-4 py-4">
          <p className="eyebrow">Швидкий фокус</p>
          <div className="mt-3 grid gap-2 text-sm leading-6 text-slate-600">
            <p>Місто тут працює як контекст: що знайти, куди піти й які сервіси вже поруч.</p>
          </div>
        </div>
      </div>
    </aside>
